...
-- John's crap
--
CREATE FUNCTION age_vle(IN gtype, IN vertex, IN vertex, IN gtype, IN gtype, IN gtype, IN gtype, OUT edges gtype) RETURNS SETOF gtype LANGUAGE C STABLE CALLED ON NULL INPUT PARALLEL UNSAFE AS 'MODULE_PATHNAME';
-- TODO: remove
