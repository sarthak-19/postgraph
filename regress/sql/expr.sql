...
SELECT * from cypher('time', $$RETURN date_part('Year',make_timestamptz(2023, 2, 14, 5, 30, 0.0, 'GMT'))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Month',make_timestamptz(2023, 2, 14, 5, 30, 0.0, 'GMT'))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Day',make_timestamptz(2023, 2, 14, 5, 30, 0.0, 'GMT'))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Hour',make_timestamptz(2023, 2, 14, 5, 30, 0.0, 'GMT'))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Minutes',make_timestamptz(2023, 2, 14, 5, 30, 0.0, 'GMT'))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Second',make_timestamptz(2023, 2, 14, 5, 30, 0.0, 'GMT'))$$) as (range agtype);

SELECT * from cypher('time', $$RETURN date_part('Year',make_timestamp(2023, 2, 14, 5, 30, 0.0))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Month',make_timestamp(2023, 2, 14, 5, 30, 0.0))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Day',make_timestamp(2023, 2, 14, 5, 30, 0.0))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Hour',make_timestamp(2023, 2, 14, 5, 30, 0.0))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Minutes',make_timestamp(2023, 2, 14, 5, 30, 0.0))$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Second',make_timestamp(2023, 2, 14, 5, 30, 0.0))$$) as (range agtype);
